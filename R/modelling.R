...
#' @param newdata -arg for rentrack::predict.train()- <data.frame> containing
#' the input data to consider in a model prediction.
#' @param forceGlobalInputFeatures -arg for rentrack::predict.train()- <list> 
...
#' number of rows.
#' @param forceInitInputFeatures -arg for rentrack::predict.train()- <list>
#' containing the last timesteps of the input features.
#' @param forceInitOutputFeatures -arg for rentrack::predict.train()- <list>
#' containing the last timesteps of the output feature.
#' @param forceOneStepPrediction -arg for rentrack::predict.train()- 
#' <boolean> indicating if the prediction mode should be done in one step 
#' prediction mode. 
#' @param predictionIntervals -arg for rentrack::predict.train()- 
...
#' # rentrack::predict.train() function for predicting. 
...
#' <boolean> indicating if the prediction mode should be done in one step 
#' prediction mode. 
#' @param predictionHorizonInHours -arg for rentrack::predict.train()- 
...
#' is not used.
#' @param modelWindow -arg for rentrack::predict.train()- <string> containing the 
...
#' @param modelSelection -arg for rentrack::predict.train()- <string> defining 
